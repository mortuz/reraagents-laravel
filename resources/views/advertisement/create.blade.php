        ...
        <div class="card-body">
          ...
          <form autocomplete="off" action="{{ route('advertisement.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input name="link" id="link" type="text" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" value="{{ old('link') }}"/>
              @if ($errors->has('link'))
                <span class="invalid-feedback" role="alert">
            ...
            <button class="btn btn-gradient-primary mt-3" type="submit">Create advertisement</button>
