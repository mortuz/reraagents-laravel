      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('office.store') }}" method="POST">
            ...
            <input name="mobile" id="mobile" type="text" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}"/>
            ...
            <input name="url" id="url" type="text" class="form-control{{ $errors->has('url') ? ' is-invalid' : '' }}"/>
              @if ($errors->has('url'))
                <span class="invalid-feedback" role="alert">
            ...
            <div class="form-check mx-sm-2">
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input" name="govt" {{ old('status') ? 'checked' : '' }} value="1"> It is a Government office <i class="input-helper"></i></label>
            </div>
