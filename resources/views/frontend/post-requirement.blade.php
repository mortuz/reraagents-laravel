      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
              <div class="card-header"> <h5>Post your requirement</h5> </div>
              <div class="card-body">
                <div>
                ...
                <form action="{{ route('page.property.sell') }}" method="post" id="form" style="display: none">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      ...
                      <textarea class="form-control" id="requirement" rows="3" name="requirement"></textarea>
                    </div>


                  <button type="submit" class="btn float-right btn2 mt-4">Post requirement</button>
    ...
    <script>
      ...
      $('#form').validate({
        ...
        submitHandler: function(form) {
          ...
          var url = "{{ route('post.guest.requirement') }}";
          $.ajax({
            type: 'post',
            url: url,
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (!response.success) {
              ...
              swal({
                title: "Success!",
                text: "Your requirement posted with id " + response.data.id + ". We will get back to you after review.",
                icon: "success",
              });
            }
          },
