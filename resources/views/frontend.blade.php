...
<body>
    ...
    <section class="bg-hero" style="background-image: url({{ asset('img/img3.jpeg') }}">
        <nav class="navbar navbar-expand-lg fixed-nav navbar-light pt-3">
            <a class="navbar-brand" href="#"><img class="logo-header" src="{{ asset('img/rera_new.png') }}" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="topNav">
                <ul class="navbar-nav ml-auto ham-menu d-flex align-items-center">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><img class="playstore-img " src="{{ asset('img/download-on-the-app-store-icon-0.png') }}"
                                alt=""></a>
                    </li>
                    <li class="nav-item active">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">This is a wider card with supporting text below as a natural
                                        lead-in.</p>
                                    <p class="card-text mb-3"><span class="card-text">Property Id: <span class="color-red"
                                                style="font-weight:bold;">318</span> , <span class="color-grey" style="font-weight:bold;">2019-04-09</span></span>
                                    </p>
